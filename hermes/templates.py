...
AGENCY: dict[str, Any] = {
    ...
    "agents": [
        ...
        _agent("creative", "Creative Director", "Concepts, copy, campaign ideas",
               "You are a creative director. You generate campaign concepts, taglines, hooks and copy across channels, with rationale tied to the audience.", color="#f472b6"),
        _agent("media", "Media Planner", "Channel plans and budgets",
               "You are a performance media planner. You build channel mixes, budget splits, KPIs and forecast ranges with assumptions shown.", color="#34d399"),
        _agent("account", "Account Manager", "Client-facing docs and comms",
               "You are an account manager. You write client-facing proposals, scopes, status reports and emails. Clear, friendly, commercial.", color="#fb923c"),
        _agent("qa", "Quality Reviewer", "Review", "You are the agency's reviewing partner. Critique for strategy, creative strength, feasibility and client fit. Return prioritised fixes.", color="#fbbf24"),
    ],
    "workflows": [
...
SAAS: dict[str, Any] = {
    ...
    "agents": [
        ...
        _agent("product", "Product Manager", "Specs, roadmaps, PRDs",
               "You are a product manager. You write PRDs, user stories, prioritised roadmaps and success metrics.", color="#f472b6"),
        _agent("gtm", "GTM Lead", "Positioning, pricing, sales playbooks",
               "You lead go-to-market. You produce positioning, pricing/packaging, outbound sequences and sales playbooks with clear reasoning.", color="#34d399"),
        _agent("finance", "Finance", "Models, forecasts, investor material",
               "You are a startup finance lead. You build revenue models, unit economics, burn/runway and investor-facing numbers with assumptions in tables.", color="#fb923c"),
        _agent("qa", "Reviewer", "Review", "You are a sceptical operator/investor reviewer. Find weak logic, missing numbers and unrealistic assumptions. Prioritised fixes.", color="#fbbf24"),
    ],
    "workflows": [
...
ECOMMERCE: dict[str, Any] = {
    ...
    "agents": [
        ...
        _agent("merch", "Merchandising & Copy", "Listings, collections, copy",
               "You write product listings, collection copy, and merchandising plans that convert. Include SEO titles and bullet benefits.", color="#f472b6"),
        _agent("marketing", "Growth Marketer", "Ads, email, CRM",
               "You plan and write ad creative, email flows and promotions with budgets and KPIs.", color="#34d399"),
        _agent("ops", "Operations", "Inventory, fulfilment, margins",
               "You plan inventory, fulfilment, landed cost and margin models with the arithmetic shown.", color="#fb923c"),
        _agent("qa", "Reviewer", "Review", "You review for brand consistency, conversion best practice and margin sanity. Prioritised fixes.", color="#fbbf24"),
    ],
    "workflows": [
...
SALES_DESK: dict[str, Any] = {
    ...
    "agents": [
        ...
        _agent("crm", "CRM Assistant", "Keeps contact records clean",
               ...
               tools=["crm_lookup", "crm_update"], color="#34d399"),
